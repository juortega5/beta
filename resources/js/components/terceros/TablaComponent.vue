<template>
	<div>
		<table class="table table-dark table-hover table-bordered table-sm">
			<thead>
				<tr align="center">
					<th colspan="6">Listado de Terceros</th>
					<th>
						<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-backdrop="static" data-target="#crearTercero">
						  Nuevo+
						</button>
					</th>
				</tr>
				...
				<tbody>
					<tr v-for="tercero in terceros">
						...
						<td align="center">{{ tercero.nit }}</td>      
						...
						<td align="center">
							<button type="button" @click="editTerceros(tercero)" class="btn btn-primary btn-sm" data-toggle="modal" data-backdrop="static" data-target="#crearTercero">
							  Editar
							</button>
						</td>
						<td align="center">
							<button type="button" @click="deleteTerceros(tercero)" class="btn btn-danger btn-sm" data-toggle="modal" data-backdrop="static" data-target="#deleteTercero">
							  Eliminar
							</button>
						</td>
					</tr>
